...
public abstract class Operation {
	...
	public static Operation read(JsonReader jr) throws IOException {
	...
	abstract public void run(MainFrame parent, List<String> vars, JPanel output, boolean isRelaunch) throws IOException;
	
	abstract public void write(JsonWriter jw) throws IOException;
}