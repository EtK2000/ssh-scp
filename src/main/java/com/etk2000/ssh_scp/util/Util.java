...
public class Util {
	...
	public static URL getResource(String path) {
		URL res = Util.class.getResource("/resources" + path);
		return res != null ? res : Util.class.getResource(path);
	}
	
	public static void guardInternalAPI() {
		if (Util.class.getClassLoader() != Thread.currentThread().getContextClassLoader())
			throw new IllegalAccessError("Plugins cannot call internal API");
	}
